    ...
    <el-col :span="22" :offset="1">
        ...
        <el-row class="row">
            <el-table :data="tableData" class="table" stripe>
                ...
                <el-table-column label="地址范围" min-width="270">
                    <template slot-scope="scope">
                        {{scope.row.Start + ' - ' + scope.row.End}}
                    </template>
                </el-table-column>
                <el-table-column prop="Gateway" label="网关" min-width="140"></el-table-column>
                <el-table-column prop="Netmask" label="子网掩码" min-width="140"></el-table-column>
                <el-table-column prop="LeaseTime" label="租期" min-width="80"></el-table-column>
                ...
                <el-table-column label="已分配" min-width="100">
                    <template slot-scope="scope">
                        <el-tag size="medium">{{scope.row.UsedIpNum + ' / ' + scope.row.IpNum}}</el-tag>
                    </template>
                </el-table-column>
                <!-- Table Panel End -->
            ...
            <el-form label-position="left"
                ...
                <el-form-item label="本机地址">
                    <el-select v-model="formData.ServerIdentifier"
                               ...
                               filterable
                               clearable>
                        <el-option v-for="(item,index) in options.V4Ip"
                                   :key="index"
                                   :label="item.value"
                                   :value="item.value">
                        </el-option>
                ...
                <el-form-item label="保留的地址" style="width: 100%;">
                    <el-row style="width: 400px">
                        <el-input v-model="formData.ReservAddr"
                                  clearable
                                  type="textarea"
                                  :autosize="{ minRows: 2, maxRows: 4}"
                                  placeholder="请输入保留的地址">
                        </el-input>
                    </el-row>
                </el-form-item>

                <el-form-item label="子网掩码">
                    <el-select v-model="formData.Netmask"
                               placeholder="请选择本机地址"
                               filterable
                               clearable>
                        <el-option v-for="(item,index) in options.V4Ip"
                ...
                <el-form-item label="网关">
                    <el-select v-model="formData.Gateway"
                               placeholder="请选择本机地址"
                               filterable
                               clearable>
                        <el-option v-for="(item,index) in options.V4Ip"
                ...
                <el-form-item label="租期">
                    <el-input v-model="formData.LeaseTime"
                              clearable
                              placeholder="请输入租期">
                    </el-input>
                </el-form-item>
                ...
                <el-form-item label="Mac 绑定有效期">
                    <el-input v-model="formData.MacBind"
                              clearable
                              placeholder="请输入 Mac 绑定有效期">
                    </el-input>
                </el-form-item>
